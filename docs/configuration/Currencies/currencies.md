...
{% include image.html file="image171.jpg" class="docimage" url="https://admin-dev.aapli.dev/admin/configurations/currency-settings" alt="Currencies" caption="Currencies" %}
