...
{% include image.html file="image172.jpg" class="docimage" url="https://admin-dev.aapli.dev/admin/configurations/currency-settings" alt="Currency Settings" caption="Currency Settings" %}
