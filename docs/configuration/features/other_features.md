...
2. **Points Reset:** This feature gives admins the option to reset Points accumulated by users on the platform. The admin can set a date at which point the reset occurs.