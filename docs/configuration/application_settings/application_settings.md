...
{% include image.html file="applicationsettings1.jpg" class="docimage" url="https://admin-dev.aapli.dev/admin/configurations/application-settings" alt="Application Settings" caption="Application Settings" %}
