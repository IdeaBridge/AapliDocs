...
{% include image.html file="image166.jpg" class="docimage" url="https://admin-dev.aapli.dev/admin/configurations/company-profile" alt="Company Name, Theme and Logo" caption="Company Name, Theme and Logo" %}
