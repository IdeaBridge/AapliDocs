...
{% include image.html file="image176.jpg" class="docimage" url="https://admin-dev.aapli.dev/admin/configurations/sso-setting" alt="Add SSO Settings" caption="Add SSO Settings" %}
