...
{% include image.html file="image174.jpg" class="docimage" url="https://admin-dev.aapli.dev/admin/configurations/sso-setting" alt="SSO Settings" caption="SSO Settings" %}
