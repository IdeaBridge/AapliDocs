...
{% include image.html file="userimportsettings1.jpg" class="docimage" url="https://admin-dev.aapli.dev/admin/configurations/user-import-mapping" alt="User Import Mapping" caption="User Import Mapping" %}
...
{% include image.html file="userimportsettings2.jpg" class="docimage" url="https://admin-dev.aapli.dev/admin/configurations/user-import-mapping" alt="User Import Mapping" caption="User Import Mapping" %}
