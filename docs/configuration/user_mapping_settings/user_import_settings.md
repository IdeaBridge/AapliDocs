...
{% include image.html file="userimportsettings.jpg" class="docimage" url="https://admin-dev.aapli.dev/admin/configurations/user-import-mapping" alt="User Import Mapping" caption="User Import Mapping" %}
