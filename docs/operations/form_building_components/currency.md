...
{% include image.html file="img1.jpg" url="https://admin-dev.aapli.dev/admin/operations/application-management" alt="Currency" caption="Currency" %}
...
{% include image.html file="img2.jpg" url="https://admin-dev.aapli.dev/admin/operations/application-management" alt="Currency" caption="Currency" %}
...
{% include image.html file="img3.jpg" url="https://admin-dev.aapli.dev/admin/operations/application-management" alt="Currency" caption="Currency" %}
...
{% include image.html file="img4.jpg" url="https://admin-dev.aapli.dev/admin/operations/application-management" alt="Currency" caption="Currency" %}

**Validation**

{% include image.html file="img5.jpg" url="https://admin-dev.aapli.dev/admin/operations/application-management" alt="Currency" caption="Currency" %}
...
{% include image.html file="img6.jpg" url="https://admin-dev.aapli.dev/admin/operations/application-management" alt="Currency" caption="Currency" %}
