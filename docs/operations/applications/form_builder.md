...
{% include image.html file="imag10.jpg" class="docimage" url="https://admin-dev.aapli.dev/form-builder" alt="Applications Panel" caption="Applications Panel" %}
...
{% include image.html file="imag11.jpg" class="docimage" url="https://admin-dev.aapli.dev/form-builder" alt="Applications Panel" caption="Applications Panel" %}

### Renaming a Form Tab:

{% include image.html file="imag12.jpg" class="docimage" url="https://admin-dev.aapli.dev/form-builder" alt="Applications Panel" caption="Applications Panel" %}
...
We can also make it visible at the start by marking the checkbox **“Visible at start”** under the Tabs Permissions

{% include image.html file="imag13.jpg" class="docimage" url="https://admin-dev.aapli.dev/form-builder" alt="Applications Panel" caption="Applications Panel" %}
...
{% include image.html file="imag14.jpg" class="docimage" url="https://admin-dev.aapli.dev/form-builder" alt="Applications Panel" caption="Applications Panel" %}
...
{% include image.html file="imag15.jpg" class="docimage" url="https://admin-dev.aapli.dev/form-builder" alt="Applications Panel" caption="Applications Panel" %}
...
{% include image.html file="imag16.jpg" class="docimage" url="https://admin-dev.aapli.dev/form-builder" alt="Applications Panel" caption="Applications Panel" %}
...
{% include image.html file="imag17.jpg" class="docimage" url="https://admin-dev.aapli.dev/form-builder" alt="Applications Panel" caption="Applications Panel" %}

**General**
The General property of a Section consists of two fields:

{% include image.html file="imag18.jpg" class="docimage" url="https://admin-dev.aapli.dev/form-builder" alt="Applications Panel" caption="Applications Panel" %}
...
{% include image.html file="imag19.jpg" class="docimage" url="https://admin-dev.aapli.dev/form-builder" alt="Applications Panel" caption="Applications Panel" %}
...
{% include image.html file="imag20.jpg" class="docimage" url="https://admin-dev.aapli.dev/form-builder" alt="Applications Panel" caption="Applications Panel" %}
...
{% include image.html file="imag21.jpg" class="docimage" url="https://admin-dev.aapli.dev/form-builder" alt="Applications Panel" caption="Applications Panel" %}
...
{% include image.html file="imag22.jpg" class="docimage" url="https://admin-dev.aapli.dev/form-builder" alt="Applications Panel" caption="Applications Panel" %}

We can also add Team Members By clicking on + Add section.