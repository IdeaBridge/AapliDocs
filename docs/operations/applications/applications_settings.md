...
4. **Type:** Type decides how users will interact with your application.
      **1. Response Only:** If you just want to collect answers or feedback from users.
      **2. Request and Response:** If users need to ask for something and then respond to it, like placing a request and then giving feedback.
