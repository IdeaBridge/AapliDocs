...
{% include image.html file="image134.jpg" class="docimage" url="https://admin-dev.aapli.dev/admin/operations/application-categories" alt="Application Category" caption="Application Category" %}
