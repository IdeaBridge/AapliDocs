...
{% include image.html file="image134.jpg" class="docimage" url="https://admin-dev.aapli.dev/admin/operations/application-categories" alt="Add a application category" caption="Add a Application Category" %}
