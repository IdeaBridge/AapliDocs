...
{% include image.html file="image138.jpg" class="docimage" url="https://admin-dev.aapli.dev/admin/operations/application-categories" alt="Edit a Category" caption="Edit an Existing Category" %}
