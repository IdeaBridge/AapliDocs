...
2. **Time Range Filter:** This dropdown defines how far back in time the user wants to see across the e-mails sent by the suborganisation:
    ...
    - Last 30 Days
    - Last 60 Days
3. **Created Date:** The date of each e-mail sent by the suborganisation.
4. **To:** The user address the e-mail was sent to.
5. **Subject:** The subject defined in the e-mail.
6. **Status:** How long ago the e-mail was sent, and what action has been taken on the e-mail since.
7. **Actions:** The user can delete any unwanted e-mail from this panel if they wish.