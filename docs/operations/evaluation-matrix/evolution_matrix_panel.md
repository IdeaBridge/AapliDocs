...
{% include image.html file="image142.jpg" class="docimage" url="https://admin-dev.aapli.dev/admin/operations/evaluation-matrix-management" alt="Evolution Matrix Panel" caption="Evolution Matrix Panel" %}
