...
This widget allows admins to create relational databases for their website, and to display them in the form of entity tables.
These tables can be edited, and their relationships & structures re-defined, with the intent to use them as foundations for applications.
...
3. **Description:** This column lists the descriptions attached to each created entity; another sorting column through A-Z or Z-A.
4. **Actions:** Here, the user can choose to either edit the entity or completely delete it from the database.